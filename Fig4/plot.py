...
ax1.plot (data_diff[:,0], data_diff[:,1], 'v', color='#446280', markersize=marker_size, label = r'$g_{\Omega}(r,t|0,0)$')
...
ax2.plot (data_annih[x_arr,0], data_annih[x_arr,1], 'v', color='#446280',markersize=marker_size, label = r'$g_{\Omega}(r,t|0,0)$')
